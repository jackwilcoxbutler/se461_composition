...
//		  between the two classes. This will make our program more extendable. For instance
//		  in this current inheritance a Fixed Array CAN be resized due to inheriting that 
//		  method, which is incorrect and violates the rules and intent of the class.
