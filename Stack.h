...
private:
  // Dr. R: Make sure to use a trailing underscore to indicate this is a member attribute.
  Array<T> array_;
  // Dr. R: We shouldn't need size here as the underlying array holds the size.
  //FIX remove size_
